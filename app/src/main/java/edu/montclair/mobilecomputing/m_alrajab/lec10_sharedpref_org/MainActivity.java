...
public class MainActivity extends AppCompatActivity
    ...
    class Lstnr implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            final View viewGrp = getLayoutInflater().inflate(R.layout.costum_dialog_layout,
            ...
            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(MainActivity.this)
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            tv.setText(noteTitle.getText() + "1s");
                            ...
                            try {
                                ...
                                outputStream.close();
                                Snackbar.make(viewGrp, "File Saved", Snackbar.LENGTH_SHORT).show();
                            } catch (Exception e) {
